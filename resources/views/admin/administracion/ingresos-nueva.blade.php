...
<div class="row">
    ...
    <div class="col-12">
        <form id="frm_buscar_pagos_pendinetes" action="{{route('ingresos.filtro')}}" method="POST">
            <div class="row mt-3 text-10">
                ...
                <div class="col-2 d-none">
                    ...
                    {{-- <button type="button" class="btn btn-outline-primary" onclick="buscar_ingresos('frm_buscar_pagos_pendinetes',$('#opcion').val())">BUSCAR</button> --}}
