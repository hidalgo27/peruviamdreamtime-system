    ...
    <div style="font-family:Lato,sans-serif;font-size:15px;color:#666666" marginheight="0" marginwidth="0">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" align="center" width="600">
                        ...
                        <tr bgcolor="#ffffff">
                            <td valign="top" style="padding:10px 35px 0 35px;color:#ffffff">
                                <img class="CToWUd" width="350" alt="logo gotoperu" src="http://sistema.gotoperu.com.pe/img/logos/logo-gotoperu-3.png" style="vertical-align:top;max-width:220px">
                            </td>
                        </tr>
                        @yield('content')
                        </tbody>
        ...
        <table cellspacing="0" cellpadding="0" border="0" bgcolor="#f6f6f6" align="center" width="100%" height="50">
            ...
            <tr>
                ...
                <td>
                    <img class="CToWUd" width="250" alt="logo gotoperu" src="http://sistema.gotoperu.com.pe/img/logos/logo-ave-gotoperu.png" style="vertical-align:top;max-width:220px">
                </td>
            </tr>
            </tbody>
        </table>
