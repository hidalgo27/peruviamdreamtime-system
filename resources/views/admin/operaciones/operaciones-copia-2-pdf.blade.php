        ...
        <table class="table text-08">
                ...
                @foreach($arreglo_de_datos as $key => $array_datos_coti_)
                    ...
                    <tr class="@if($array_datos_coti_['COTIZACION_STATE']==0) venta_anulada @endif">
                        <td style="width:50px">{!! MisFunciones::fecha_peru($array_datos_coti_['FECHA']) !!}</td>
                        <td style="width:10px">{!!$datos[1]!!}</td>
                        <td style="width:50px">{!!$datos[2]!!}</td>
                        <td style="width:50px">{!!$datos[3]!!}</td>
                        <td style="width:15px">{!!$array_datos_coti_['HORA']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['TOURS']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['REPRESENT']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['HOTELS']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['MOVILID']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['ENTRANCES']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['FOOD']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['TRAINS']!!}</td>
                        <td style="width:40px">{!!$array_datos_coti_['FLIGHTS']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['OTHERS']!!}</td>
                        <td style="width:80px">{!!$array_datos_coti_['OBSERVACIONES']!!}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
